  ...
  if (rewards.length === 0) {
    return (
      <div className="text-center py-8">
        ...
        <p className="text-gray-900 font-semibold mb-1">Henüz ödül bulunmuyor</p>
        <p className="text-gray-700 text-sm">Yakında yeni ödüller eklenecek</p>
      </div>
    );
  }
      ...
      {rewards.map((reward) => (
        <div key={reward.id} className="bg-white border border-coffee-100 rounded-xl overflow-hidden hover:shadow-md transition-shadow">
          ...
          <div className="p-4">
            ...
            <p className="text-sm text-gray-700 mt-1 mb-4">{reward.description}</p>
